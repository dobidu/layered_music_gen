...
- [ ] 04-05-orchestrator-collapse-and-ast-guard-PLAN.md — Collapse music_gen.py from 523 to <200 lines: delete 9 audio functions (mix_and_save + 8 helpers); rewrite create_song to chain renderer → mixer → beats → annotator; delete beat_anotator.py outright (D-03); add tests/test_no_bare_random_in_package.py AST guard (D-17/D-31). (R-X4, R-X5, R-X6, R-X7)
