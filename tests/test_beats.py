...
This file is a Wave 0 skipping stub. Plan 04-01 (Wave 1) replaces the entire
...
pytest.skip(
    "Plan 04-00 (Wave 0) scaffold — Plan 04-01 (Wave 1) will replace this stub.",
    allow_module_level=True,
)


def test_placeholder():
    """Placeholder; will be replaced by Plan 04-01's real tests."""
    pass
